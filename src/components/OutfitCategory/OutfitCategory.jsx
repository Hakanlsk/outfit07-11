...
import FavouriteId from "../FavouriteId";
...
const OutfitCategory = () => {
  ...
  const [favoriteIds, setFavoriteIds] = useState([]); // Favori yapılan ürünlerin id'lerini saklayan dizi
  ...
  const toggleFavorite = (id) => {
    if (favoriteIds.includes(id)) {
      // Favori yapılan ürünü favorilerden çıkar
      setFavoriteIds(favoriteIds.filter((favoriteId) => favoriteId !== id));
    } else {
      // Favori yapılacak ürünü favorilere ekle
  ...
  return (
    <div className="flex justify-center">
      <div className="xsm:mx-auto">
        ...
        <FavouriteId favoriteIds={favoriteIds} />
